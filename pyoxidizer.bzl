...
def make_exe(dist):
    ...
    # exe.add_python_resources(exe.pip_download([CWD + "/pysrc"]))
    exe.add_python_resources(exe.pip_install(["-r", CWD + "/pysrc/requirements.txt", "--global-option=--without-libyaml"]))
